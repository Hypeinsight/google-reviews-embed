...
4. Click **"PSQL Command"** - this will show you a command like:
   ```
   PGPASSWORD=xxx psql -h xxx.render.com -U xxx xxx
   ```
5. Copy and run that command in your terminal (it will connect you to Render's database)

6. Once connected, copy the entire content of `db/migration_billing.sql` and paste it
7. Press Enter to run it

8. Then copy the content of `db/update_stripe_prices.sql` and paste it
9. Press Enter to run it

10. Type `\q` to exit

## Option 2: Copy Files Manually

### Step 1: Run migration_billing.sql

Connect to Render database and run these commands:
...
-- Insert pricing tiers with YOUR Stripe price IDs
...
You should see all 4 tiers with your Stripe price IDs!

---

**After migration is complete, deploy your code to Render and you're live! 🚀**
